...
HD_PWD='H:/gyx verilog/digital/lab_1/lab1_4_2/lab1_4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_4_2.tcl
