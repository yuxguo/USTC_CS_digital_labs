...
HD_PWD='H:/gyx verilog/digital/lab_1/lab1_4_2/lab1_4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_4_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_4_2.tcl -notrace
