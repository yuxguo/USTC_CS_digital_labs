...
#et_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { x[5] }]; #IO_L7N_T1_D10_14 Sch=sw[5]
...
#et_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { y[4] }]; #IO_L7P_T1_D09_14 Sch=led[4]
