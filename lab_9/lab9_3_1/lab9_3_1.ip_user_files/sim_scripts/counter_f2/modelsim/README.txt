...
#
# Generated by export_simulation on Thu Nov 22 22:17:26 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './counter_f2.sh' script.

./counter_f2.sh -reset_run
...
./counter_f2.sh -noclean_files

For more information on the script, please type './counter_f2.sh -help'.
