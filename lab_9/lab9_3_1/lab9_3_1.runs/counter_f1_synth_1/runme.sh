...
HD_PWD='H:/gyx verilog/digital/lab_9/lab9_3_1/lab9_3_1.runs/counter_f1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_f1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_f1.tcl
