...
HD_PWD='H:/gyx verilog/digital/lab_9/lab9_3_1/lab9_3_1.runs/counter_f2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_f2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_f2.tcl
