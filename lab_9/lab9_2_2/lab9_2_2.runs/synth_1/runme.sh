...
HD_PWD='H:/gyx verilog/digital/lab_9/lab9_2_2/lab9_2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab9_2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab9_2_2.tcl
