...
HD_PWD='H:/gyx verilog/digital/lab_9/lab9_2_2/lab9_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab9_2_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab9_2_2.tcl -notrace
